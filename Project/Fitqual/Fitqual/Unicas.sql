...
ALTER TABLE Comidas ADD CONSTRAINT uq_comidas_plan_nombre UNIQUE (planfitness, nombre_comida);

-- Dentro de un mismo plan el nombre del habito deberia ser unico
ALTER TABLE Habitos ADD CONSTRAINT uq_habitos_plan_nombre UNIQUE (planfitness, nombre_habito);
