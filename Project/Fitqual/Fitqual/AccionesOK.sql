...
INSERT INTO RutinasDeEjemplo VALUES (300, 301, 'Example Routine', 'Rutina ejemplo', 'Lunes, Miércoles, Viernes', 50, 'Intermedio', 'Fuerza');
INSERT INTO RutinasDeEjemplo VALUES (301, 303, 'Routine SET NULL Test', 'Rutina para SET NULL', 'Martes, Jueves', 40, 'Básico', 'Cardio');

INSERT INTO EjerciciosDeRutinasDeEjemplo VALUES (300, 300, 'Example Exercise', 3, 15, 'Ejercicio ejemplo', 4);
INSERT INTO EjerciciosDeRutinasDeEjemplo VALUES (301, 301, 'Exercise to Delete', 4, 12, 'Ejercicio a eliminar',4);
...
-- Prueba 1: Eliminar Plan → Elimina Rutinas y Ejercicios en cascada
DELETE FROM PlanesFitness WHERE id_plan = 301;
-- Verificar: Rutina 301 y Ejercicio 301 deben eliminarse
...
------------------
-- 3. PRUEBAS ON DELETE SET NULL
------------------

-- Prueba 4: Eliminar Especialista → RutinasDeEjemplo mantienen registro (SET NULL)
DELETE FROM EspecialistasFitness WHERE id_persona = 303;
-- Verificar: RutinaDeEjemplo 303 debe mantener id_rutina pero con especialista_fitness = NULL
